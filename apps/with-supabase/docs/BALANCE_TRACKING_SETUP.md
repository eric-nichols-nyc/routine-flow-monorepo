...
```javascript
// Import the action
const { recordAllBalanceSnapshots } =
  await import("/actions/record-balance-snapshot");
...
```json
{
  ...
  "data": [
    ...
    { "date": "Oct 26", "balance": 2680.2 },
    { "date": "Oct 27", "balance": 2515.5 },
    { "date": "Oct 28", "balance": 2620.0 },
    { "date": "Nov 24", "balance": 3125.0 }
  ]
}
```
