...
```typescript
["accounts", userId][("account", accountId)][ // All accounts // Single account
  ("account-transactions", accountId, "2024")
][("dashboard", userId)][("balance-history", accountId, period)]; // Account transactions // Dashboard data // Balance history
```
